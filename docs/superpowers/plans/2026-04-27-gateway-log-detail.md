...
- [x] **Step 2: IGatewayPresenter 新增 getLogDetail**
...
- [x] **Step 3: 修改 relay.ts — StatsCallback 类型**
...
- [x] **Step 4: 新增 filterRequestForLog 函数**
